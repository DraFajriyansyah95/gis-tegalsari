          ...
          <div id="carouselExampleDark" class="carousel carousel-dark slide mh-50" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item active" data-bs-interval="10000">
                <img src="<?php echo $image_url;?>sliders/Kerja_Bakti.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                  <h5>Kerja Bakti</h5>
                  <p>Kegiatan Gotong Royong Warga Tegalsari.</p>
                </div>
              </div>

              <div class="carousel-item" data-bs-interval="10000">
                <img src="<?php echo $image_url;?>sliders/Pelebaran_Jalan.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                  <h5>Pelebaran Jalan Cimuncang</h5>
                  <p>Kegiatan Kepala Desa Mengecek Jalan Cimuncang.</p>
                </div>
              </div>
              <div class="carousel-item" data-bs-interval="10000">
              ...
              <div class="carousel-item" data-bs-interval="10000">
                <img src="<?php echo $image_url;?>sliders/Vaksin.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                  <h5>Kegiatan Vaksin</h5>
                  <p>Kegiatan Pemberian Vaksin Covid-19.</p>
                </div>
              </div>
              <div class="carousel-item" data-bs-interval="10000">
